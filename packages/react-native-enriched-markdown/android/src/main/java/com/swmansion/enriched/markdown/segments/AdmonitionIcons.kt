...
/**
 * GitHub admonition/alert header assets shared with iOS and web.
 *
 * The `d` path strings are taken verbatim from @primer/octicons (16x16 viewBox)
 * and MUST stay byte-identical across the three renderers so the glyph looks the
 * same everywhere:
